...
export const zh = {
  ...
  loading: '加载中…',
  refreshing: '刷新中…',
  presetGroups: 'Agent 预设构成',
  presetDefault: '默认',
  presetBroken: '无法读取',
  presetConditional: '条件（!!js）',
  presetNoRows: '该预设没有构成行。',
  noEntries: '没有条目。',
  unobserved: '未观察',
  catalogTab: '插件',
  catalog: '插件列表',
  ...
  confirmRestore: '将向该环境批量重装备份缺失项，确认执行？',
...
export const en = {
  ...
  presetGroups: 'Agent preset compositions',
  presetDefault: 'default',
  presetBroken: 'unreadable',
  presetConditional: 'conditional (!!js)',
  presetNoRows: 'This preset has no composition rows.',
  ...
  marketEmptyCategory: 'No entries in this category.',
  sortDefault: 'Default',
  sortAz: 'A-Z',
  sortEnabled: 'Enabled',
  sortAsc: 'Ascending',
  ...
  confirmRestore: 'This will batch-reinstall every missing entry into the target environment. Confirm?',
